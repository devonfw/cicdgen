...
* --docker
+
The type of this parameter if boolean. If it is present, docker related files and pipeline stage will be also generated. For more details see docker section of Jenkinsfile and xref:devon4net-docker-generated-files[files generated for docker]
+
* `--dockerurl`
+
...
* --openshift
+
The type of this parameter if boolean. If it is present, OpenShift related files and pipeline stage will be also generated. For more details see OpenShift section of Jenkinsfile and xref:devon4net-docker-generated-files[files generated for OpenShift] (same as `--docker`)
+
* `--ocname`
+
